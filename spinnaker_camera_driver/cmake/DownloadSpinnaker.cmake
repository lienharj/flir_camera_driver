function(download_spinnaker FLIR_LIB_VAR FLIR_INCLUDE_DIR_VAR)
  ...
  set(${FLIR_LIB_VAR} "${FLIR_DIR}/libSpinnaker.so;${FLIR_DIR}/libGenApi_gcc540_v3_0.so" PARENT_SCOPE)
  set(${FLIR_INCLUDE_DIR_VAR} "${CMAKE_CURRENT_BINARY_DIR}/opt/spinnaker/include" PARENT_SCOPE)
endfunction()
